    ...
    let mahasiswaData = [
        {
            ...
            tempat_tgl_lahir: 'Jakarta, 01-01-2000',
            agama: 'Islam',
            nama_ibu: 'Fatima',
            no_hp_ortu: '081234567890',
            email_ortu: 'fatima@example.com',
            statusKip: 'Aktif', // Tambahkan status KIP
            periodeAktif: 'Ganjil 2024/2025 - Genap 2024/2025', // Tambahkan periode aktif
            pembayaran: [
                { periode: 'Ganjil 2024/2025', tanggalCair: '2024-10-15', jumlah: 'Rp 6.000.000', status: 'Cair', keterangan: 'Pembayaran semester ganjil' },
                { periode: 'Genap 2024/2025', tanggalCair: '2025-04-20', jumlah: 'Rp 6.000.000', status: 'Cair', keterangan: 'Pembayaran semester genap' },
                { periode: 'Ganjil 2025/2026', tanggalCair: '-', jumlah: '-', status: 'Pending', keterangan: 'Menunggu verifikasi' }
            ],
            rekening: {
        ...
        },
        {
            ...
            tempat_tgl_lahir: 'Bandung, 15-05-1999',
            agama: 'Islam',
            nama_ibu: 'Dewi',
            no_hp_ortu: '085678901234',
            email_ortu: 'dewi@example.com',
            statusKip: 'Pending', // Contoh status
            periodeAktif: 'Belum Ditetapkan',
            pembayaran: [
                { periode: 'Ganjil 2024/2025', tanggalCair: '-', jumlah: '-', status: 'Pending', keterangan: 'Proses pengajuan' }
            ],
            rekening: {
                namaBank: 'Bank BRI',
                nomorRekening: '9876543210987',
                atasNama: 'Siti Aminah',
                cabangBank: 'Bandung Utara'
            }
        },
        {
            nim: '2023010',
            ...
            nama: 'Charlie Brown',
            jenis_kelamin: 'Laki-laki',
            tempat_tgl_lahir: 'Surabaya, 10-03-2001',
            agama: 'Kristen',
            nama_ibu: 'Lucy',
            no_hp_ortu: '087811223344',
            email_ortu: 'lucy@example.com',
            statusKip: 'Tidak Aktif',
            periodeAktif: 'Ganjil 2023/2024',
            pembayaran: [
                { periode: 'Ganjil 2023/2024', tanggalCair: '2023-09-01', jumlah: 'Rp 6.000.000', status: 'Cair', keterangan: 'Pembayaran semester ganjil' }
            ],
            rekening: {
                namaBank: 'Bank BCA',
                nomorRekening: '1122334455667',
                atasNama: 'Charlie Brown',
                cabangBank: 'Surabaya Timur'
            }
        }
    ];
